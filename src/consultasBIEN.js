...
/*Estamos haciendo un repaso de los platos con alimentos que tenemos que pedir para el proximo día, y queremos saber 
si tenemos ingredientes que no caducan o que caducan mas tarde del mes que viene. */
db.restaurante.find({
    $or:[
...
/*{ "_id" : 8, "ingredientes" : [ { "ing" : "limón", "caducidad" : ISODate("2021-12-05T00:00:00Z") }, { "ing" : "hielo" } ] }
{ "_id" : 10, "ingredientes" : [ { "ing" : "garbanzos" }, { "ing" : "ajo" }, { "ing" : "limón", 
    "caducidad" : ISODate("2021-12-05T00:00:00Z") }, { "ing" : "yogurt", "caducidad" : ISODate("2021-11-16T00:00:00Z") } ] }
{ "_id" : 12, "ingredientes" : [ { "ing" : "chocolate" }, { "ing" : "galletas", 
    "caducidad" : ISODate("2022-11-01T00:00:00Z") }, { "ing" : "laminas de oro" } ] } */ 
